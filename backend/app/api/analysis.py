...
def _persist_analysis(
    ...
    analysis = Analysis(
        ...
        reviews_available=result.get("reviews_available"),
        review_highlights=result.get("review_highlights"),
        review_complaints=result.get("review_complaints"),
        review_recurring_defects=result.get("review_recurring_defects"),
        review_satisfaction=result.get("review_satisfaction"),
        supplier_profile=result.get("supplier_profile"),
        target_audiences=result.get("target_audiences"),
        target_audience_explanation=result.get("target_audience_explanation"),
        import_strategy=result.get("import_strategy"),
        seasonality=result.get("seasonality"),
        saturation_level=result.get("saturation_level"),
        saturation_explanation=result.get("saturation_explanation"),
        complementary_products=result.get("complementary_products"),
        logistics_profile=result.get("logistics_profile"),
        recommended_transport=result.get("recommended_transport"),
        transport_explanation=result.get("transport_explanation"),
        import_difficulty=result.get("import_difficulty"),
        import_difficulty_explanation=result.get("import_difficulty_explanation"),
        marketing_claims=result.get("marketing_claims"),
        importer_summary=result.get("importer_summary"),
